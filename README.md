# 🚀 Global News 24 | Desktop NEWS aggregator

## 📌 Overview
Global News 24 is a desktop news aggregation application built using Python and Tkinter. It fetches real-time headlines using NewsAPI and presents them in a clean, scrollable interface with support for
